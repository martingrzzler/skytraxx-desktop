...
export default function Home() {
  ...
  async function fetchTar() {
    ...
    await fs.writeBinaryFile("update.tar", await res.arrayBuffer(), {
    ...
    <div className="m-10">
      ...
      <Button
        ...
        onClick={async () => {
          ...
          const mountpoint = await invoke("find_skytraxx_mountpoint");
          if (!mountpoint) {
            setError(
          ...
          const res: BackendResponse = await invoke("extract_transfer_tar", {
            tarPath: "update.tar",
            mountpoint,
          });
